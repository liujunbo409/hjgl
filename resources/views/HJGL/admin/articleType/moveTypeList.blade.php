...
@section('content')
    <div class="addRoot"id="addParent" href="#" title="文章分类移动到根目录" onclick="moveMulu({{$from_id}},0,0)" >文章分类移动到根目录</div>
...
@section('script')
    ...
    <SCRIPT type="text/javascript">
        ...
        function moveMulu(id, move_id,open_id) {
            $.ajax({
                type: 'POST',
                url: "{{URL::asset('admin/articleType/moveTypeSave')}}",
                dataType: 'json',
                data: {
                    id: id,
                    move_id: move_id,
